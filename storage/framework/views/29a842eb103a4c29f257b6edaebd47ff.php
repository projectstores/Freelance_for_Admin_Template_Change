                ...
                <div class="flex w-full max-w-sm flex-col justify-center p-5">
                	...
                	<div class="text-center">
                		<div class="mt-4">
                			<span class="text-2xl font-black text-black dark:text-white">
                				<?php echo app('translator')->get('messages.t_sign_in_to_your_account'); ?>
                			</span>
                		</div>
                	</div>
                	...
                	<div class="text-center">
                		<div class="mt-1">
                			<span class="text-lg font-normal text-black dark:text-white">
                				<?php echo app('translator')->get('messages.t_dont_have_account'); ?>
                				<a class="hover:text-primary-700 underline capitalize" href="<?php echo e(url('auth/register'), false); ?>">
        							<?php echo app('translator')->get('messages.t_join_us'); ?>	
        						</a>
                			</span>
                		</div>
                	</div>
                	...
                	<div class="mt-6">
                		...
                		<div class="w-full relative">
                			...
                			<div class="mt-1">
                				<form x-data="window.zyKtAkZuKbBmbfC" x-on:submit.prevent="login" class="grid grid-cols-12 md:gap-x-6 gap-y-5">
...
unset($__errorArgs, $__bag); ?>
                					...
                					<div class="col-span-12 flex justify-between">
                                        <div class="relative flex items-start">
                							...
                							<div class="ltr:ml-3 rtl:mr-3 text-[13px]">
                								<label for="remember_me" class="text-base font-normal text-black dark:text-gray-400 cursor-pointer"><?php echo e(__('messages.t_remember_me'), false); ?></label>
                							</div>
                						</div>
                                        <a class="hover:text-slate-600 dark:hover:text-zinc-100 hover:underline text-black dark:text-gray-400 text-base font-normal" href="<?php echo e(url('auth/password/reset'), false); ?>">
                					...
                					<div class="col-span-12">
                						<button type="submit" wire:loading.attr="disabled" wire:target="login" :disabled="!form.email || !form.password" class="w-full bg-primary-600 enabled:hover:bg-primary-700 text-white py-3 px-4 rounded-md text-bold font-bold tracking-wide disabled:bg-zinc-200 disabled:text-zinc-500 dark:disabled:bg-zinc-500 dark:disabled:text-zinc-300 disabled:cursor-not-allowed">
...
<?php $__env->stopPush(); ?><?php /**PATH /home1/onesend1/public_html/new-freelance.turboconnect.top/resources/views/livewire/main/auth/login.blade.php ENDPATH**/ ?>
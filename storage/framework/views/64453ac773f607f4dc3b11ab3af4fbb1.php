...
} elseif ($_instance->childHasBeenRendered('tYAKPmy')) {
    $componentId = $_instance->getRenderedChildComponentId('tYAKPmy');
    $componentTag = $_instance->getRenderedChildComponentTagName('tYAKPmy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('tYAKPmy');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('tYAKPmy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('2cf6kgL')) {
    $componentId = $_instance->getRenderedChildComponentId('2cf6kgL');
    $componentTag = $_instance->getRenderedChildComponentTagName('2cf6kgL');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2cf6kgL');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('2cf6kgL', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home1/onesend1/public_html/new-freelance.turboconnect.top/resources/views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>
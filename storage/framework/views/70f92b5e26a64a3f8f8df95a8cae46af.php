...
} elseif ($_instance->childHasBeenRendered('GVCxCE4')) {
    $componentId = $_instance->getRenderedChildComponentId('GVCxCE4');
    $componentTag = $_instance->getRenderedChildComponentTagName('GVCxCE4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GVCxCE4');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('GVCxCE4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('nq5EGiK')) {
    $componentId = $_instance->getRenderedChildComponentId('nq5EGiK');
    $componentTag = $_instance->getRenderedChildComponentTagName('nq5EGiK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nq5EGiK');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('nq5EGiK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home1/onesend1/public_html/new-freelance.turboconnect.top/resources/views/livewire/main/layout/app2.blade.php ENDPATH**/ ?>
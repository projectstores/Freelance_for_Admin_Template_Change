...
} elseif ($_instance->childHasBeenRendered('2QXpSAp')) {
    $componentId = $_instance->getRenderedChildComponentId('2QXpSAp');
    $componentTag = $_instance->getRenderedChildComponentTagName('2QXpSAp');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2QXpSAp');
} else {
    $response = \Livewire\Livewire::mount('main.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('2QXpSAp', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Pufh7G4')) {
    $componentId = $_instance->getRenderedChildComponentId('Pufh7G4');
    $componentTag = $_instance->getRenderedChildComponentTagName('Pufh7G4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Pufh7G4');
} else {
    $response = \Livewire\Livewire::mount('main.includes.footer');
    $html = $response->html();
    $_instance->logRenderedChild('Pufh7G4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</html><?php /**PATH /home1/onesend1/public_html/new-freelance.turboconnect.top/resources/views/livewire/main/layout/app.blade.php ENDPATH**/ ?>
<div class="w-full">
    ...
    <div class="mb-12 bg-white dark:bg-zinc-800 rounded-lg px-3 py-3 border border-gray-300 dark:border-zinc-700 dark:shadow-none max-w-7xl mx-auto">
        
        
        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 rounded-t-md border-b border-gray-300 dark:border-zinc-700">
            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                <h3 class="text-2xl leading-6 font-semibold text-black dark:text-gray-100 tracking-wide "><?php echo e(__('messages.t_contact_us'), false); ?></h3>
                </div>
            </div>
        </div>
...
<?php endif; ?>
        ...
        <div class="px-4 py-6 bg-gray-50 dark:bg-zinc-700 border-t border-gray-300 dark:border-zinc-700 sm:px-10 text-center">
            <p class="text-base leading-5 text-gray-500 dark:text-gray-300">
...
</div><?php /**PATH /home1/onesend1/public_html/new-freelance.turboconnect.top/resources/views/livewire/main/help/contact/contact.blade.php ENDPATH**/ ?>
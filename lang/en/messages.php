...
"t_offers_pending_approval"                                => "Offers pending approval",
        ...
        "t_contact_us_subtitle"                                    => 'If you want to reach us, Fill Below form, need to get in touch with us? Fill the form below with your inquiry and our team will contact you soon',
        "t_name"                                                   => "Name",
        ...
        "t_my_projects"                                            => 'My jobs',
        "t_create_project"                                         => 'Create job',
        "t_project_id"                                             => 'Job ID',
        "t_project"                                                => 'Jobs',
        "t_back_to_projects"                                       => 'Back to job',
        "t_project_title"                                          => 'Job title',
        "t_enter_project_title"                                    => 'Enter job title',
        "t_project_description"                                    => 'Job description',
        "t_enter_project_description"                              => 'Enter job description',
        "t_project_thumbnail"                                      => 'Job thumbnail',
        "t_project_link_optional"                                  => "Job link (optional)",
        "t_https_example_com"                                      => "https://www.example.com",
        "t_project_video_optional"                                 => 'Job video (optional)',
        "t_project_images"                                         => "Job images",
        "t_ur_project_created_successfully"                        => "Your job has been successfully added",
        "t_about_this_project"                                     => "About this job",
        ...
        "t_share_this_project"                                     => "Share this job",
        "t_live_preview"                                           => "Live preview",
        "t_watch_video"                                            => "Watch video",
        "t_no_projects"                                            => "No jobs",
        "t_this_user_has_no_projects_yet"                          => "This user has no jobs right now.",
        "t_update_project"                                         => "Update job",
        "t_edit_project"                                           => "Edit job",
        "t_update_project_images"                                  => "Update job images",
        "t_ur_project_updated_successfully"                        => "Your job has been successfully updated",
        ...
        "t_delete_project"                                         => "Delete job",
        "t_are_u_sure_u_want_to_delete_gig"                        => "Are you sure you want to delete this gig?",
        "t_are_u_sure_u_want_to_delete_project"                    => "Are you sure you want to delete this job from portfolio?",
        "t_auto_approve_user_portfolio"                            => "Auto approve users portfolio jobs",
        "t_project_deleted_success"                                => "Job has been successfully deleted",
        ...
        "t_ur_portfolio_title_has_been_published"                  => "Your job :title has been successfully published",
        ...
        "t_notification_user_everyone_welcome_2"                   => "Finally, there’s a lifetime of opportunities in one place. All those jobs you have planned or on hold? Just one click away. No need to prioritize, postpone, or procrastinate – thousands of skilled professionals are ready to take on your next job, from content and design to business and development. It’s time to start seeing those “to-do” tasks “done”",
        ...
        "t_notification_seller_line_1_portfolio_published"         => "You portfolio is now public, click below to see your job online",
        ...
        "t_projects"                                               => "Jobs",
        "t_projects_settings"                                      => "Jobs settings",
        "t_projects_settings_subtitle"                             => "Update jobs section settings",
        "t_enable_projects_section"                                => "Enable jobs section",
        ...
        "t_projects_subscriptions"                                 => "Jobs Subscriptions",
        "t_enable"                                                 => "Enable",
        "t_days"                                                   => "Days",
        "t_disable"                                                => "Disable",
        "t_subscription_plans"                                     => "Subscription plans",
        "t_projects_subscription_plans_subtitle"                   => "When you enable premium posting, these packages will be visible for the publisher, he can choose one or more to post a job",
        "t_edit_project_plan"                                      => "Edit jobs plan",
        ...
        "t_general"                                                => "General",
        "t_auto_approve_projects"                                  => "Auto approve jobs",
        ...
        "t_explore_projects"                                       => 'Explore Jobs',
        "t_deposit"                                                => "Deposit",
        ...
        "t_work_ur_way"                                            => 'You Keep 92%',
        "t_u_bring_the_skill_make_earn_easy"                       => 'Where talents shine, projects align, and freelancers define their prime.',
        "t_4_sec"                                                  => "4 sec",
        "t_a_gig_is_bought_every"                                  => "A Gig is bought every",
        "t_50_m_plus"                                              => '2M+',
        "t_transactions"                                           => "Transactions",
        "t_price_range"                                            => "Price range",
        "t_5_million"                                              => '1.5 Million',
        ...
        "t_i_am_a_designer"                                        => "Graphic Designer",
        "t_fake_name_alejandro_lee"                                => "Alejandro Lee",
        "t_i_am_a_developer"                                       => "Software Developer",
        "t_fake_name_elsa_king"                                    => "Elsa King",
        "t_i_am_a_writer"                                          => "Copywriter",
        "t_fake_name_herman_reese"                                 => "Herman Reese",
        "t_i_am_a_video_editor"                                    => "Video Editor",
        "t_fake_name_sue_keller"                                   => "Sue Keller",
        "t_i_am_a_musician"                                        => "Music Composer",
        "t_buyer_stories"                                          => "Buyer stories",
        "t_buyer_story_1"                                          => 'FreeLancer is fantastic! The platform is user-friendly, the freelancers are top-notch, and the communication and payment process are seamless. Highly recommended!',
        "t_buyer_story_2"                                          => 'FreeLancer exceeded my expectations. Will definitely use again in the future!',
        "t_buyer_story_3"                                          => 'Impressed with the quality of freelancers on FreeLancer! Got excellent results',
        "t_fake_name_alex_saunders"                                => "Alex Saunders",
        "t_fake_name_ricky_jones"                                  => "Ricky Jones",
        "t_fake_name_melissa_ross"                                 => "Melissa Ross",
        "t_entrepreneur"                                           => "CEO, GentLabs",
        "t_music_producer"                                         => "Producer, Ross Entertainment",
        "t_graphic_designer"                                       => "Artist, Creativo Studio",
        ...
        "t_how_much_money_can_i_make_answer"                       => 'It’s totally up to you. You can work as much as you want. Many sellers work on Freelancer full time and some keep their 9-5 job while using Riverr to make extra money.',
        "t_how_much_does_it_cost_question"                         => "How much does it cost?",
        "t_how_much_does_it_cost_answer"                           => 'It’s free to join Freelancer. There is no subscription required or fees to list your services. You keep 92% of each transaction.',
        ...
        "t_today"                                                  => 'today and Keep 92% of every gig you will sale',
        ...
        "t_post_project"                                           => "Post job",
        "t_post_new_project"                                       => "Post new job",
        "t_post_project_description_hint"                          => "Type a brief description about your job, your business, and include an overview of what you need done.",
        "t_projects_categories"                                    => "Jobs categories",
        "t_new_category"                                           => "New category",
        "t_create_projects_category"                               => "Create a jobs category",
        ...
        "t_edit_projects_category"                                 => "Edit jobs category",
        "t_choose_category"                                        => "Choose category",
        "t_delete_project_cat_has_projects_hint"                   => "It looks like this category already has jobs, Please select an alternative one to move them before you delete it.",
        ...
        "t_post_new_project_subtitle"                              => "Get started by creating a new job.",
        "t_min"                                                    => "Min",
        "t_max"                                                    => "Max",
        "t_post_project_category_hint"                             => "Select Category which fit your job requirements",
        "t_post_project_skills_hint"                               => "Enter up to 5 skills that best describe your job. Freelancers will use these skills to find jobs they are most interested and experienced in",
        ...
        "t_make_ur_project_premium_optional"                       => "Make your job premium (Optional)",
        "t_make_ur_project_premium"                                => "Make your job premium",
        "t_promotion"                                              => "Promotion",
        "t_toast_select_plan_to_post_project"                      => "Please select a plan to post your job",
        "t_who_can_post_projects"                                  => "Who can post jobs",
        "t_choose_who_can_post_new_projects"                       => "Choose who can post new jobs",
        "t_both"                                                   => "Both",
        "t_plans"                                                  => "Plans",
        "t_projects_plans"                                         => "Jobs plans",
        "t_ur_project_created_and_pending_payment"                 => "Your job has been successfully created, Please choose a method for payment",
        "t_ur_project_created_and_pending_approval"                => "Your job is pending approval now.",
        "t_ur_project_created_success"                             => "Your job has been successfully published",
        "t_max_project_price_must_be_greater"                      => "Max price must be greater than min price",
        "t_promote_project"                                        => "Promote job",
        "t_promote_project_subtitle"                               => "Get best results by making your job premium",
        "t_ur_payment_has_succeeded"                               => "Your payment has been successfully processed",
        "t_bid_now"                                                => "Bid Now",
        "t_urgent_project"                                         => "Urgent job",
        "t_project_details"                                        => "Job details",
        "t_required_skills"                                        => "Required skills",
        "t_bid_on_this_project"                                    => "Bid on this job",
        "t_beware_of_scams"                                        => "Beware of scams",
        "t_beware_of_scams_details"                                => "If you are being asked to pay a security deposit, or if you are being asked to chat on Telegram, WhatsApp, or another messaging platform, it is likely a scam. Report these jobs or contact Support for assistance.",
        "t_report_project"                                         => "Report job",
        "t_share_project"                                          => "Share job",
        "t_project_details_subtitle"                               => "Job description and required skills",
        "t_project_summary"                                        => "Job summary",
        "t_duration"                                               => "Duration",
        "t_day"                                                    => "Day",
        "t_bids"                                                   => "Bids",
        "t_avg_bid"                                                => "Avg bid",
        ...
        "t_project_summary_subtitle"                               => "Brief details about this job",
        ...
        "t_this_project_will_be_delivered_in"                      => "This job will be delivered in",
        "t_describe_ur_proposal"                                   => "Describe your proposal",
        "t_describe_ur_proposal_placeholder"                       => "enter a detailed description of your quotation that addresses the client’s requirements for the job",
        "t_continue"                                               => "Continue",
        "t_enable_promoting_bids"                                  => "Enable promoting bids",
        "t_plans_for_promoting_projects"                           => "Plans for promoting jobs",
        ...
        "t_bidding_plan_sponsored_subtitle"                        => 'Bids that are sponsored are 518% more likely to be hired. Stand out from the rest of the freelancers, by being pinned to the top of the employer’s bid list. There is only one sponsored bid per job.',
        ...
        "t_bidding_plan_highlight_subtitle"                        => 'Make your bid highlighted in yellow for greater visibility to the employer and a higher chance of being hired for the job.',
        ...
        "t_error"                                                  => "Error",
        "t_project_not_active_to_send_proposals"                   => "This job is not active to send proposals",
        "t_u_cant_submit_bids_to_urself"                           => "You cannot bid on your jobs.",
        "t_u_already_submitted_a_bid_to_this_project"              => "You already submitted your bid on this job",
        ...
        "t_report_bid_reason_1"                                    => "Bidder did not read job description",
        ...
        "t_notification_admin_reported_bid"                        => "A bid has been reported in this job",
        ...
        "t_report_project_reason_3"                                => "Fake job posted",
        "t_report_project_reason_4"                                => "Obscenities or harassing behaviour",
        "t_report_project_reason_5"                                => "Non-full time job posted requiring abnormal bidding",
        "t_report_project_reason_6"                                => "Other",
        "t_pls_login_or_register_report_project"                   => "Please login or register to report this job",
        "t_u_cannot_report_ur_own_projects"                        => "You cannot report your own jobs",
        "t_u_already_reported_this_project"                        => "You already reported this job",
        "t_we_have_received_bid_report_success"                    => "We have received your report and will investigate and take action on it shortly.",
        "t_subject_admin_project_reported"                         => "Someone has reported a job",
        "t_notification_admin_reported_project"                    => "The following job has been reported",
        "t_reported_projects"                                      => "Reported jobs",
        "t_this_project_is_closed_for_bidding"                     => "This job is closed for bidding",
        "t_find_another_project"                                   => "Find another job",
        "t_my_projects_subtitle"                                   => "Manage your jobs",
        "t_confirm_delete"                                         => "Confirm delete",
        "t_are_u_sure_u_want_to_delete_this_project"               => "Are you sure you want to delete this job",
        "t_all_records_related_to_project_will_erased"             => "All records related to this job will be erased. This action cannot be undone.",
        "t_success"                                                => "Success",
        "t_open"                                                   => "Open",
        ...
        "t_project_is_not_open_for_bid"                            => "This job is not open for bid right now",
        "t_this_bid_is_not_awarded_to_revoke_it"                   => 'This bid is not to revoke it',
        ...
        "t_latest_projects"                                        => "Latest jobs",
        "t_payouts"                                                => "Payouts",
        "t_selected_upgrades"                                      => "Selected upgrades",
        "t_notification_admin_bid_pending_approval"                => "Bid pending approval",
        "t_u_received_new_bid_on_ur_project"                       => "You have received a new bid for your job",
        "t_ur_bid_has_been_posted"                                 => "You bid on this job has been successfully posted",
        "t_ur_bid_has_been_posted_pending_approval"                => "Your bid on this job has been added and pending approval",
        ...
        "t_projet_already_awarded_u_cant_promote_bid"              => 'For this job has already been hired to someone else and you cannot promote your bid.',
        "t_promote_bid_subtitle"                                   => 'Promote your bid to get higher chance to be hired',
        "t_awarded_projects"                                       => 'Hired jobs',
        "t_my_bids"                                                => "My bids",
        "t_accept_the_project"                                     => "Accept the job",
        "t_project_overview"                                       => "Job overview",
        "t_send_a_message"                                         => "Send a message",
        "t_awarded_projects_warning_msg"                           => "You can now start working on this job after the employer place a milestone payment. We strongly suggest that you do not start work until a Milestone Payment is in place. A Milestone Payment protects you because you can start work with peace of mind, knowing that the funds are there.
        ",
        "t_awarded_projects_subtitle"                              => 'List of jobs hired to you from employers',
        "t_reject_the_project"                                     => "Reject the job",
        "t_pending_ur_approval"                                    => "Pending your approval",
        "t_u_have_36_hours_to_accept_project"                      => 'Don’t keep them waiting! You have 36 hours to accept before the job of the job is retracted automatically.',
        "t_proposal_message"                                       => "Proposal message",
        "t_confirmation"                                           => "Confirmation",
        "t_accept_project_confirmation_freelancer_msg"             => "You will be redirect to the job overview section, where you can share files of the jobs with the employer and request milestones.",
        "t_pls_let_us_know_why_reject_this_project_freelancer"     => "Please let us know why you want to reject this job.",
        "t_freelancer_reject_project_reason_1"                     => "Job is spam or fraud",
        ...
        "t_freelancer_reject_project_reason_6"                     => "I do not have the skills to do the job",
        "t_freelancer_reject_project_reason_7"                     => "I do not have time to take on the job",
        "t_freelancer_reject_project_reason_8"                     => "Other",
        "t_pls_select_rejection_reason"                            => "Please select a rejection reason first",
        "t_ur_bid_will_hidden_after_reject"                        => "Your bid on this job will be hidden after you reject this job",
        "t_freelancer_u_have_reject_this_project_success"          => "You have successfully rejected this job",
        "t_u_have_no_awarded_projects_yet"                         => 'You have no hired jobs yet.',
        "t_freelancer_u_have_accepted_this_project_success"        => "You have successfully accepted this job",
        "t_no_project_found_in_our_records"                        => "No job found in our records. Please try again.",
        "t_caching"                                                => "Caching",
        "t_employer"                                               => "Employer",
        "t_view_project"                                           => "View job",
        "t_reject"                                                 => "Reject",
        "t_approve_project"                                        => "Approve job",
        "t_are_u_sure_approve_project_admin"                       => "Are you sure you want to approve the following job?",
        "t_reject_project"                                         => "Reject job",
        "t_delete_project_admin_alert"                             => "Please remember that anything related to this job will be erased, including bids, subscriptions, milestones... \n Make sure to delete only new jobs, that has nothing yet. \n This action cannot be undone.",
        ...
        "t_delete_bid_admin_alert"                                 => 'Are you sure you want to delete this bid? Please make sure this bid is not hired first.',
        ...
        "t_u_cannot_create_milestones_for_this_project"            => "You cannot create milestone payment for this job",
        ...
        "t_search_in_ur_contacts"                                  => "Search contacts",
        "t_you"                                                    => "You",
        ...
        "t_latest_awarded_projects"                                => 'Latest hired jobs',
        ...
        "t_project_budget"                                         => "Job budget",
        "t_paid_amount"                                            => "Paid amount",
        "t_u_exceeded_amount_agreed_with_employer_milestone"       => "You exceeded the job amount you agreed with the employer. Please try different amount.",
        ...
        "t_ur_projects_page_is_empty"                              => "Your jobs page is empty",
        "t_ur_projects_page_is_empty_subtitle"                     => 'Explore latest jobs and submit your proposals. Once you are hired for the job then you can see that flashing here.',
        "t_edit_my_proposal"                                       => "Edit my proposal",
        "t_more"                                                   => "More",
        "t_less"                                                   => "Less",
        "t_looks_like_u_already_awarded_project_other"             => "Looks like another freelancer already accepted your job.",
        "t_congratulations_employer_awarded_u_their_project_title" => 'Congratulations! :username hired you for their job :title',
        "t_awarded_date"                                           => 'Hired date',
        ...
        "t_complete_ur_most_pressing_work_with_project_catatlog"   => "Complete your most pressing work with job Catalog. Browse and submit your proposal to predefined jobs in just a few clicks.",
        "t_type_something_to_search_in_projects"                   => "Type something to search in jobs",
        ...
        "t_congts_freelancer_ur_project_completed"                 => "Congratulations, your job has been successfully completed.",
        "t_proposal_amount"                                        => "Proposal amount",
        "t_back_to_bids"                                           => "Back to bids",
        "t_pending_deposit_transactions"                           => "Pending deposit transactions",
        "t_pending_projects"                                       => "Pending jobs",
        "t_pending_bids_subscriptions"                             => "Pending bids subscriptions",
        "t_pending_projects_subscriptions"                         => "Pending jobs subscriptions",
        ...
        "t_username_has_deposited_amount_in_project"               => ":username has deposited an :amount into your job",
        ...
        "t_project_completed"                                      => "Job completed",
        "t_subject_employer_freelancer_accepted_ur_project"        => "Your job has been accepted by the freelancer",
        "t_notification_username_has_accepted_ur_project"          => ":username has accepted to work on your job",
        "t_subject_employer_freelancer_rejected_ur_project"        => "Your job has been rejected by the freelancer",
        "t_notification_username_has_rejected_ur_project"          => ":username has rejected to work on your job",
        ...
        "t_subject_employer_project_completed"                     => "Job has been completed",
        "t_notification_ur_project_has_been_completed"             => "Your job has been completed by the freelancer",
        "t_subject_employer_project_approved"                      => "Job has been approved",
        "t_notification_ur_project_has_been_approved"              => "Your job has been approved",
        "t_subject_employer_project_needs_changes"                 => "Job needs changes",
        "t_notification_ur_project_has_been_rejected"              => "Your job needs some changes",
        ...
        "t_notification_freelancer_employer_has_deposited_funds"   => "Employer has deposited funds in your job",
        ...
        "t_subject_freelancer_u_awarded_a_project"                 => 'You are hired for job',
        "t_notification_congts_u_awarded_a_project"                => "Congratulations! you have awarded a job",
        "t_popular_services"                                       => "Popular services",
        "t_access_freelance_talent"                                => "Access Worldwide Freelance Talent",
        "t_newsletter_image"                                       => "Newsletter Image",
        "t_home_settings"                                          => "Home section settings",
        "t_start_selling_settings"                                 => "Start selling section settings",
        "t_start_selling_settings_subtitle"                                 => "Update Start selling section settings",
        "t_home_section_settings_subtitle"                         => "Update the home section settings",
        "t_show_popular_services"                                  => "Show Popular Services",
        "t_show_made_with"                                         => "Show Made With",
        "t_show_join_us_banner"                                    => "Show Join Us Banner",
        "t_show_benefits"                                          => "Show Benefits",
        "t_show_home_video"                                        => "Show Home Video",
        "t_join_us_banner_image"                                   => "Join Us Banner Image",
        "t_youtube_video_id"                                       => "Youtube Video ID",
        "t_youtube_video_id_placeholder"                           => "Enter Youtube Video ID",
        "t_youtube_video_id_hint"                                  => "eg. Nd45FNMJ0Dk",
        "t_where_talents_shine"                                    => "Where talents shine, projects align, and freelancers define their prime.",
        "t_hero_tagline"                                           => "Hero Tagline",
        "t_enter_hero_tagline"                                     => "Enter Hero Tagline",
        "t_freelance_service_fingertips"                           => "Freelance services at your fingertips!",
        "t_show_gigs"                                              => "Show Gigs In Home",
        "t_benefits_1_logo"                                        => "Benefits 1 Logo",
        "t_benefits_2_logo"                                        => "Benefits 2 Logo",
        "t_benefits_3_logo"                                        => "Benefits 3 Logo",
        "t_benefits_4_logo"                                        => "Benefits 4 Logo",
        "t_benefits_title"                                         => "Unlock a World of<br>Freelance Talent Across Continents",
        "t_benefits_1_title"                                       => "Global Opportunities Await",
        "t_benefits_2_title"                                       => "Tailored Matches",
        "t_benefits_3_title"                                       => "Secure Transactions",
        "t_benefits_4_title"                                       => "Community and Support",
        "t_benefits_1_subtitle"                                    => "Your platform bridges freelancers and clients worldwide. Whether you’re in Manila or New York, your next gig is just a click away.",
        "t_benefits_2_subtitle"                                    => "Our algorithms connect freelancers with precisely matched projects. No more irrelevant listings—each opportunity aligns perfectly with their skills, preferences, and availability.",
        "t_benefits_3_subtitle"                                    => "Our platform ensures freelancers’ earnings are protected through secure payment gateways, escrow services, and transparent contracts. Clients can collaborate confidently.",
        "t_benefits_4_subtitle"                                    => "Our platform brings freelancers together through forums, webinars, and networking events. Responsive support ensures everyone feels valued.",
        "t_upload_made_with_images"                                => "Made With images",
        "t_whats_included"                                         => "What's Included",
        "t_order_in_queue"                                         => "Order In Queue",
        "t_order_in_queue_number"                                  => ":number order",
        "t_orders_in_queue_number"                                 => ":number orders",
        "t_delivery_time_2"                                        => "Delivery Time",
        "t_continue_price"                                         => "Continue (:price)",
        "t_project_details"                                        => "Project Details",
        "t_this_project_number"                                    => "This Project (:count)",
        "t_all_project_number"                                     => "All Projects (:count)",
        "t_about"                                                  => "About",
        "t_about_desc"                                             => "Lancer is an innovative platform that provides a simple and effective way for freelancers and employers to connect and collaborate.",
        "t_apply"                                                  => "Apply",
        "t_clear"                                                  => "Clear",
        "t_jobs_you_might_like"                                    => "Jobs you might like",
        "t_posted_date"                                            => "Posted :date",
        "t_proposals_2"                                            => "Proposals:",
        "t_less_than_5"                                            => "Less than 5",
        "t_between_5_20"                                           => "Between 5 and 20",
        "t_between_20_50"                                          => "Between 20 and 50",
        "t_more_than_50"                                           => "More than 50",
        "t_estimated_budget"                                       => "Est. Budget:",
        "t_project_type"                                           => "Project Type:",
        "t_skills_and_expertise"                                   => "Skills and Expertise",
        "t_apply_now"                                              => "Apply Now",
        "t_flag_as_inappropriate"                                  => "Flag as Inappropriate",
        "t_bids_number"                                            => ":number bids",
        "t_current_bids"                                           => "Current Bids:",
        "t_average_bids"                                           => "Average Bids:",
        "t_project_clicks"                                         => "Project Clicks:",
        "t_project_clicks_number"                                  => ":number clicks",
        "t_impressions"                                            => "Impressions:",
        "t_impressions_number"                                     => ":number impressions",
        "t_job_link"                                               => "Job Link",
        "t_about_the_client"                                       => "About the client",
        "t_account_not_verified"                                   => "Account not verified",
        "t_member_since_2"                                         => "Member Since",
        "t_last_delivery_2"                                        => "Last Delivery",
        "t_email_address_2"                                        => "E-mail Address:",
        "t_top_rated"                                              => "Top Rated",
        "t_statistics"                                             => "Statistics",
        "t_under_progress"                                         => "Under progress",
        "t_welcome_back_2"                                         => "Welcome back!",
        "t_no_orders_yet"                                          => "No orders yet",
        "t_no_job_yet"                                             => "No jobs yet",
        "t_account"                                                => "Account",
        "t_billing"                                                => "Billing",
        "t_session"                                                => "Session",
        "t_projects_2"                                             => "Projects",
        "t_hire_best_professionals"                                => "Hire the best Online professionals",
        "t_check_out_professionals"                                => "Check out Online professionals with the skills you need for your next job.",
        "t_sign_in_to_your_account"                                => "Sign in to your account",
        "t_create_an_account"                                      => "Create an account",
        "t_we_are_happy"                                           => "We're happy to see you again",
        "t_dont_have_account"                                      => "Don’t have an account?",
        "t_scale_your_workforce"                                   => "Scale your workforce",
        "t_the_premium_solution"                                   => "The premium solution for businesses",
        "t_start_selling"                                          => "Start Selling",
        "t_show_how_it_works"                                      => "Show \"How It Works\" section",
        "t_show_join_community"                                    => "Show \"Join Community\" section",
        "t_show_testimonials"                                      => "Show \"Testimonials section\"",
        "t_show_faq"                                               => "Show FAQ section",
        "t_hiw_logo_1"                                             => "How it works icon 1",
        "t_hiw_logo_2"                                             => "How it works icon 2",
        "t_hiw_logo_3"                                             => "How it works icon 3",
        "t_banner_bg"                                              => "Banner Background",
        "t_banner_icon"                                            => "Banner Icon",
        "t_freelancer_image_1"                                     => "Freelancer Image 1",
        "t_freelancer_image_2"                                     => "Freelancer Image 2",
        "t_freelancer_image_3"                                     => "Freelancer Image 3",
        "t_freelancer_image_4"                                     => "Freelancer Image 4",
        "t_freelancer_name_1"                                      => "Freelancer Name 1",
        "t_freelancer_name_2"                                      => "Freelancer Name 2",
        "t_freelancer_name_3"                                      => "Freelancer Name 3",
        "t_freelancer_name_4"                                      => "Freelancer Name 4",
        "t_freelancer_job_1"                                       => "Freelancer Job 1",
        "t_freelancer_job_2"                                       => "Freelancer Job 2",
        "t_freelancer_job_3"                                       => "Freelancer Job 3",
        "t_freelancer_job_4"                                       => "Freelancer Job 4",
        "t_testimonial_name_1"                                     => "Testimonial Name 1",
        "t_testimonial_name_2"                                     => "Testimonial Name 2",
        "t_testimonial_name_3"                                     => "Testimonial Name 3",
        "t_testimonial_job_1"                                     => "Testimonial Job 1",
        "t_testimonial_job_2"                                     => "Testimonial Job 2",
        "t_testimonial_job_3"                                     => "Testimonial Job 3",
        "t_testimonial_image_1"                                    => "Testimonial Image 1",
        "t_testimonial_image_2"                                    => "Testimonial Image 2",
        "t_testimonial_image_3"                                    => "Testimonial Image 3",
        "t_testimonial_review_1"                                   => "Testimonial Review 1",
        "t_testimonial_review_2"                                   => "Testimonial Review 2",
        "t_testimonial_review_3"                                   => "Testimonial Review 3",
        "t_inbox"                                                  => "Inbox",
    ];
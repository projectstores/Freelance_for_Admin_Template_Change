...
<html lang="{{ app()->getLocale() }}" dir="{{ config()->get('direction') }}" @class(['dark' => current_theme() === 'dark'])>
    ...
    <body class="antialiased dark:bg-[#161616] text-gray-600 min-h-full flex flex-col application application-ltr overflow-x-hidden overflow-y-scroll {{ app()->getLocale() === 'ar' ? 'application-ar' : '' }}" style="overflow-y: scroll">
                    ...
                    <div class="mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center">
                        <div class="w-full">
                            ...
                            <div class="mt-6 sm:mt-12 flex justify-center">
                                ...
                                {{-- Search form --}}
                                <form class="flex items-center mb-4" action="{{ url('search') }}" accept="GET" style="background-color: #FFF; border-radius: 10px; padding-right: 9px; padding-top: 5px; padding-bottom: 5px; width: 800px;">   
        
                                    {{-- Input --}}
                                    <div class="relative w-full">
                                        <input type="search" name="q" class="bg-white border-none text-gray-900 text-lg font-medium rounded-xl block w-full ltr:pl-5 rtl:pr-10 px-2.5 py-4 focus:outline-none focus:ring-0" placeholder="{{ __('messages.t_what_service_are_u_looking_for_today') }}" required>
                                    </div>
               ...
               <div class="messenger">
                    ...
                    <div class="messenger-listView ltr:border-r rtl:border-l dark:border-zinc-700">
                            ...
                            <nav class="w-full mt-4">
                                <div class="w-full px-8">
                                    <div class="relative rounded-md shadow-sm">
                                        ...
                                        <input type="text" class="messenger-search block w-full rounded-full text-black border-2 border-gray-200 dark:border-zinc-700 ltr:pl-10 rtl:pr-10 focus:border-primary-600 focus:ring-primary-600 sm:text-sm" placeholder="@lang('messages.t_search_in_ur_contacts')">
                                    </div>
                                </div>
                            </nav>
                        ...
                        <div class="m-body contacts-container mt-5">
                           ...
                           {{-- ---------------- [ Group Tab ] ---------------- --}}
                           <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll mt-5" data-view="groups">
                                {{-- items --}}
                        ...
                        <div class="m-header m-header-messaging py-5 border-b dark:border-zinc-700 px-4" style="display: none">
                            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                                ...
                                <div class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                                    ...
                                    {{-- Username --}}
                                    <span class="user-name show-infoSide cursor-pointer dark:!text-white text-black text-2xl">{{ config('app.name') }}</span>

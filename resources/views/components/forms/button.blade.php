...
<button 
    ...
    class="{{ $block ? 'w-full' : '' }} text-base font-bold flex justify-center {{ $active }} py-3 px-8 rounded tracking-wide focus:outline-none focus:shadow-outline cursor-pointer"
    {{ $attributes }}
    >
